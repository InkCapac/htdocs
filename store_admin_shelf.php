...
if (isset($_POST["tipo"])) {
    ...
    $conexion->hacer_consulta("INSERT INTO catalogo (id_item, nombre_item, descripcion_item, precio_item, imagen_item, contenedor) VALUES (?,?,?,?,?,?)", "issisi", [$id_item, $nombre_item, $descripcion_item, $precio_item, $imagen_item, $contenedor]);
}
$conexion = new Conectar($servidor, $usuario, $contrasena, $bbdd);
