...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-11-2024 a las 23:34:58
...
CREATE TABLE `periodos` (
  ...
  `id_usuario` int(11) DEFAULT NULL,
  `id_portfolio` int(11) DEFAULT NULL,
  `fecha_inicio1` date DEFAULT NULL,
  `fecha_fin1` date DEFAULT NULL,
  `fecha_inicio2` date DEFAULT NULL,
  `fecha_fin2` date DEFAULT NULL,
  `fecha_inicio3` date DEFAULT NULL,
  `fecha_fin3` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `periodos`
  ADD CONSTRAINT `periodos_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `periodos_ibfk_2` FOREIGN KEY (`id_portfolio`) REFERENCES `portfolios` (`id`);
